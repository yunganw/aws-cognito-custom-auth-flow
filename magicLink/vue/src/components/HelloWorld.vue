        ...
        <div class="modal-body">
          <div v-if="status === 'show'">
            ...
            <br/>
                <div>
                  <form id="signInForm" @submit.prevent="login">
                    ...
                    <p></p>
                    <b-button variant="success" type="submit" form="signInForm" value="Submit">Sign In</b-button>
                    <a class="redirect-customizable" href="/forgotpassword" style="font-size:14px"
            ...
            <div>
              ...
              <input
                type="button"
                value="Get magic link sent to email"
                class="btn btn-info magiclink-btn"
            ...
            <div>
              ...
              <b-button class="btn google-button socialButton-customizable" style="padding:6px"
              ...
              <br />
              <b-button class="btn google-button socialButton-customizable" style="padding:6x"
              v-on:click="oauthLogin('SAMLIDP')">
              <img src="https://uploads-ssl.webflow.com/5b219b78a710aa89f7fe9cc9/5b7102d1b3323e057102ca6a_saml%20logo.svg"
              width="19px" style="margin-left:6px"/>
              <span style="margin-left:16px">
                Sign in with SAML</span>
              </b-button>
