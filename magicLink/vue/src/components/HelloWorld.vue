               ...
               <div>
                 ...
                 <div><div><div>
                    <span class="idpDescription-customizable">Sign In with your social account</span>
                     <button name="googleSignUpButton" onclick="window.location.href=&#39;https://magiclink.auth.us-east-1.amazoncognito.com/oauth2/authorize?identity_provider=Google&amp;redirect_uri=http://localhost:8080/social&amp;response_type=CODE&amp;client_id=235qakl0if7b3vss5ikehppnmi&amp;scope=aws.cognito.signin.user.admin email openid phone profile&#39;" class="btn google-button socialButton-customizable">
